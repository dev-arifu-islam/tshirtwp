...
<div class="page-content">
	...
	<?php if( isset($error) && try_to_count($error) ) { ?>
	...
	<form class="form-horizontal" method="post" action="<?php echo admin_url('index.php?page=tshirtecommerce-setting&step=store'); ?>">
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<?php if( isset($pages) && try_to_count($pages) ) { ?>
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<?php if( $layouts != false && is_object($layouts) && try_to_count($layouts) > 0 ) { ?>
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<?php if( $languages != false && try_to_count($languages) > 0 ) { ?>
		...
		<div class="form-group">
			...
			<div class="col-xs-7">
				...
				<?php if( $currencies != false && try_to_count($currencies) > 0 ) { $i = 1; ?>
		...
		<p class="text-right">
			...
			<button type="submit" class="btn btn-success <?php if( isset($error) && try_to_count($error) ) echo 'disabled'; ?>" role="button">Save & Continue</button>
		</p>
	</form>
</div>